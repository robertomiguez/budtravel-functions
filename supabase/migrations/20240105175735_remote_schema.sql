...
CREATE TABLE IF NOT EXISTS "public"."ticket" (
    ...
    "quote_date_time" timestamp with time zone NOT NULL,
    "leg" jsonb NOT NULL,
...
CREATE POLICY "ticket are viewable by everyone" ON "public"."ticket" FOR SELECT TO authenticated, anon USING (true);
